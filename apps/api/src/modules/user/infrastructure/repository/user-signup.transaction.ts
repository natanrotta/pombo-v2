...
/**
 * Atomic signup — single-user boilerplate. Creates ONLY the `user` row and
 * returns a fully-hydrated `User` entity so the use case can hand it straight
 * to the profile builder without a follow-up `findById`.
 */
